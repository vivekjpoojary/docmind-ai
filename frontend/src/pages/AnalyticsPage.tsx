    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      <div>
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-bold font-display text-slate-100">Personal Usage & Index Analytics</h1>
        </div>
      ...
      {loading ? (
        <div className="p-8 text-center text-slate-500 font-mono text-xs">Loading analytics metrics...</div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="glass-panel-interactive p-6 rounded-2xl">
            <div className="p-3 bg-cyber-cyan/10 rounded-xl text-cyber-cyan border border-cyber-cyan/20 w-fit mb-4">
              <FileText className="w-6 h-6" />
            </div>
            <p className="text-xs font-mono font-semibold text-slate-400 uppercase tracking-wider">Indexed Documents</p>
          ...
          <div className="glass-panel-interactive p-6 rounded-2xl">
            ...
            <p className="text-xs font-mono font-semibold text-slate-400 uppercase tracking-wider">Total Document Pages</p>
            <p className="text-3xl font-extrabold font-display text-white mt-1">{stats?.total_pages ?? 0}</p>
          </div>

          <div className="glass-panel-interactive p-6 rounded-2xl">
            <div className="p-3 bg-cyber-indigo/10 rounded-xl text-cyber-indigo border border-cyber-indigo/20 w-fit mb-4">
              <Sparkles className="w-6 h-6" />
            </div>
            <p className="text-xs font-mono font-semibold text-slate-400 uppercase tracking-wider">Vector Chunks (FAISS)</p>
          ...
          <div className="glass-panel-interactive p-6 rounded-2xl">
            ...
            <p className="text-xs font-mono font-semibold text-slate-400 uppercase tracking-wider">Conversations Created</p>
          ...
          <div className="glass-panel-interactive p-6 rounded-2xl">
            ...
            <p className="text-xs font-mono font-semibold text-slate-400 uppercase tracking-wider">Questions Asked</p>
            <p className="text-3xl font-extrabold font-display text-white mt-1">{stats?.total_questions_asked ?? 0}</p>
          </div>

          <div className="glass-panel-interactive p-6 rounded-2xl">
            <div className="p-3 bg-emerald-500/10 rounded-xl text-emerald-400 border border-emerald-500/20 w-fit mb-4">
              <HardDrive className="w-6 h-6" />
            </div>
            <p className="text-xs font-mono font-semibold text-slate-400 uppercase tracking-wider">Storage Consumed</p>
